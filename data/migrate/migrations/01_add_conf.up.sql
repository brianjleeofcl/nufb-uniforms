CREATE TABLE b1g_teams (
    seasons INT4RANGE,
    division VARCHAR[],
    crossover VARCHAR[]
);

INSERT INTO b1g_teams (seasons, division, crossover) VALUES
('[2011,2013]'::int4range,'{"Iowa","Michigan","Minnesota","Michigan State","Nebraska"}','{"Ohio State","Indiana","Wisconsin","Illinois","Purdue","Penn State"}'),
('[2014,2023]'::int4range,'{"Iowa","Minnesota","Nebraska","Wisconsin","Illinois","Purdue"}','{"Michigan","Michigan State","Ohio State","Indiana","Penn State","Maryland","Rutgers"}');
